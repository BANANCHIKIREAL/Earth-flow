...
export function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="dark min-h-screen flex animate-page-enter">
      <div className="hidden panel:flex w-[44%] xl:w-[40%] shrink-0 flex-col items-center justify-center p-16 relative overflow-hidden" style={{ background: "#0c0c0e" }}>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 py-12 min-h-screen" style={{ background: "#111115" }}>
        <Link to="/" className="panel:hidden flex items-center gap-2 mb-10 hover:opacity-80 transition-opacity">
          <div className="h-2 w-2 rounded-full bg-primary animate-pulse-soft" />
